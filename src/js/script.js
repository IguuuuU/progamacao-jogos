...
const classes = [
...
},
  {
      id: 2,
      nome: "Bardo",
      img: "./assets/img/classe/bardo.jpg"
    },
  {
      id: 3,
    nome: "Clérigo",
  ...
  },
  {
    id: 4,
    nome: "Druida",
    img: "./assets/img/classe/druida.jpg"
  },
  {
    id: 5,
    nome: "Guerreiro",
...
const regioes = [
    ...
    imagem: "./assets/img/regioes/florestaBru.jpg",
    clima: "Temperado",
    ...
    rios: true,
    mares: false,
    criaturas: ["Lobo do Pântano", "Manticora", "Troglodita do Pântano", "Fada Selvagem"],
},
{
    id: 2,
    nome: "Cavernas Abissais",
    imagem: "./assets/img/regioes/cavernaA.jpg",
    clima: "Subterrâneo",
    vegetacao: "N/A",
...

{
...

  {
    ...
    imagem: "./assets/img/regioes/florestaE.jpg",
    clima: "Nevoa",
    vegetacao: "Pantâno",
    bioma: ["Ruínas", "Rios"],
    montanhoso: true,
...
card.innerHTML += `<li><img class="personagem" src="${personagem.classeImg}" alt="${personagem.classeNome}"></li>`;
card.innerHTML += `<li> Nome: ${personagem.nome} </li>`;
card.innerHTML += `<li>  Classe: ${ personagem.classeNome } </li>`;
...
card.innerHTML += `<li> Região: ${personagem.regiao.nome}</li>`;
